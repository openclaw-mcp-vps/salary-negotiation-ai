...
- components/NegotiationChat.tsx
- components/PaymentButton.tsx
- lib/openai.ts
- lib/lemonsqueezy.ts
- lib/database.ts

DEPENDENCIES: next, react, tailwindcss, openai, @lemonsqueezy/lemonsqueezy.js, prisma, @prisma/client, stripe, lucide-react, framer-motion
